...
const char* ssid = "jung0920-1";  // insert your SSID
const char* password = "62486248";  // insert your password
...
void loop() {
  ...
  ClientRequest(String(temp-273.0), String(humidity),String(weatherfix));  //Client傳送資料
...
void ClientRequest(String value1, String value2,String value3) {
  ...
  const char* event = "Benson";  //IFTTT事件名稱
  const char* apiKey = "dqwhbsFdzEDJj5OJ6mc5nW";  //IFTTT Applet key
